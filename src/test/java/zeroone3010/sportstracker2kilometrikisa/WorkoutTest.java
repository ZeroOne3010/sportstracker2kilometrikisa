...
class WorkoutTest {
  ...
  void toStringWithZeroMinutes() {
    ...
    assertEquals("[2018-12-31: 0.0 km, 0:00:18]", workout.toString());
  }
  ...
  void toStringWithZeroHours() {
    ...
    assertEquals("[2018-12-31: 0.0 km, 0:42:00]", workout.toString());
  }
  ...
  void toStringWithMoreThan24HoursAndSomeMinutesAndSeconds() {
    ...
    assertEquals("[2018-12-31: 0.0 km, 36:02:03]", workout.toString());
  }
  ...
  void toStringWithSingleDigitMonthAndDay() {
    final Workout workout = new Workout(LocalDate.of(2018, 1, 2),
        Duration.ofMinutes(42L), BigDecimal.valueOf(0L), SportType.CYCLING);
    assertEquals("[2018-01-02: 0.0 km, 0:42:00]", workout.toString());
  }
  ...
  void toStringWithFiftyMeters() {
    ...
    assertEquals("[2018-01-02: 0.1 km, 0:42:00]", workout.toString());
  }
  ...
  void toStringWith150Meters() {
    ...
    assertEquals("[2018-01-02: 0.2 km, 0:42:00]", workout.toString());
  }
  ...
  void toStringWith12345Meters() {
    ...
    assertEquals("[2018-01-02: 12.3 km, 0:42:00]", workout.toString());
  }
}